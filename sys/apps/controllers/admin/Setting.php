...
class Setting extends Mccms_Controller {
	...
	public function pay_save()
	{
		...
		$Pay_Ali_Key = $this->input->post('Pay_Ali_Key', TRUE);
		$Pay_Ali_User = $this->input->post('Pay_Ali_User', TRUE);
		...
		$strs.="define('Pay_Ali_Key','".$Pay_Ali_Key."');\r\n";
		$strs.="define('Pay_Ali_User','".$Pay_Ali_User."');\r\n";
