                        ...
                        <div class="layui-tab-item">
                            <div class="layui-text" style="max-width: 700px;padding-top: 25px;">
                                <div class="layui-form-item w120">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="Pay_Ali_ID" placeholder="合作者身份APPID，2088开头的" value="<?=Pay_Ali_ID?>" class="layui-input"/>
                                    </div>
                                </div>
                                <div class="layui-form-item w120">
                                    <label class="layui-form-label">MD5验效码:</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="Pay_Ali_Key" placeholder="MD5安全验效码KEY" value="<?=Pay_Ali_Key?>" class="layui-input"/>
                                    </div>
                                </div>
                                <div class="layui-form-item w120">
                                    <label class="layui-form-label">支付宝账号:</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="Pay_Ali_User" placeholder="支付宝账号" value="<?=Pay_Ali_User?>" class="layui-input"/>
                                    </div>
                                </div>
                                <div class="layui-form-item w120">
